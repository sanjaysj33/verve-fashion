  ...
  const handleAction = async (name: string) => {
    try {
      if (name === 'Search') {
        ...
        toast.info('Verve is a minimalist fashion brand focusing on longevity and style.');
      } else {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="absolute left-1/2 -translate-x-1/2">
            <h1 className="text-2xl font-serif italic tracking-tighter font-bold cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Verve</h1>
          </div>
